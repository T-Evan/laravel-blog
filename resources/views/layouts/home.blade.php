...
<footer id="b-foot">
    <div class="container">
        <div class="row b-content">
            ...
            <dl class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                <dt>架构</dt>
                <dd>项目名称：<a rel="nofollow" href="https://github.com/tangmingshuai/laravel-blog" target="_blank">laravel-blog</a></dd>
                <dd>版本分支：{{ config('bjyblog.version') }}-{{ config('bjyblog.branch') }}</dd>
                <dd>项目作者：<a href="https://blog.uliuli.fun/">汤一碗</a></dd>
                <dd>主题名称：<a rel="nofollow" href="https://github.com/baijunyao/blog-theme-blueberry">blog-theme-blueberry</a></dd>
                <dd>主题作者：<a href="https://blog.uliuli.fun/">汤一碗</a></dd>
            </dl>
